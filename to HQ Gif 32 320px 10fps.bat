...
ECHO Preset: Gif 32 colors, 320px width, 10 fps, 2 pass
...
SET "wset.prepass=-vf fps=10,scale=320:-1:flags=lanczos,palettegen=max_colors=32:stats_mode=full"
SET "wset.videocomp=-filter_complex "fps=10,scale=320:-1:flags=lanczos[x];[x][1:v]paletteuse""
