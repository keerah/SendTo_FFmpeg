...
SET /A wset.fps=10
SET "wset.hline1=Preset: Gif 16 colors, 640px width, %wset.fps% fps, 2 pass"
SET "wset.params=-v %vbl% -hide_banner -stats -thread_queue_size 256"
SET "wset.prepass=-vf "fps=%wset.fps%,scale=640:-1:flags=lanczos,palettegen=max_colors=16:stats_mode=full""
