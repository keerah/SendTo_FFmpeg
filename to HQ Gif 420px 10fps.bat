...
ECHO Preset: Gif 256 colors, 420px width, 10 fps, 2 pass
...
SET "wset.prepass=-vf "fps=10,scale=420:-1:flags=lanczos,palettegen""
SET "wset.videocomp=-filter_complex "fps=10,scale=420:-1:flags=lanczos[x];[x][1:v]paletteuse""
...
IF %dscr% GTR 0 (SET "wset.dscr=_hqgif256_420_10") ELSE (SET "wset.dscr=")
