...
ECHO [---  Preset: Gif 32 colors, 640px width, 10 fps, 2 pass                             ---]
...
SET "wset.prepass=-vf "fps=10,scale=640:-1:flags=lanczos,palettegen=max_colors=32""
...
IF %dscr% GTR 0 (SET "wset.dscr=_hqgif32_640_10") ELSE (SET "wset.dscr=")
