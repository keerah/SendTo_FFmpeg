...
SET "wset.hline1=Preset: h264 mp4 CUDA 420, slow, 4 Mbps, kf 2 sec, Audio copy"
SET "wset.params=-v %vbl% -hide_banner -stats"
SET "wset.videocomp=-c:v h264_nvenc -preset slow -b:v 4M -pix_fmt yuv420p -force_key_frames 0:00:02"
...
IF %dscr% GTR 0 (SET "wset.dscr=_420_cuda_4Mbit") ELSE (SET "wset.dscr=")
