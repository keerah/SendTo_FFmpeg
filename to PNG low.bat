...
IF %dscr% GTR 0 (SET "dscrName=_pnglow") ELSE (SET "dscrName=") 
...
FOR /L %%i IN (1,1,%argCount%) DO (
	...
	"%ffpath%ffmpeg.exe" -v %vbl% -hide_banner -i "!argVec[%%i]!" -compression_level 9 -y "!argVn[%%i]!%dscrName%.png"
)
