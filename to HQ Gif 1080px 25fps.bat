...
SET "wset.prepass=-vf "fps=25,scale=1080:-1:flags=lanczos,palettegen""
SET "wset.videocomp=-filter_complex "fps=25,scale=1080:-1:flags=lanczos[x];[x][1:v]paletteuse""
