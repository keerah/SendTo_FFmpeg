...
SET "wset.hline1=Preset: h264 mp4 420, veryslow, crf 25, FILM, kf 2 sec, Audio aac192"
SET "wset.params=-v %vbl% -hide_banner -stats"
SET "wset.videocomp=-c:v libx264 -preset veryslow -crf 25 -pix_fmt yuv420p -tune film -force_key_frames 0:00:02"
...
IF %dscr% GTR 0 (SET "wset.dscr=_420_crf25_aac192") ELSE (SET "wset.dscr=")
