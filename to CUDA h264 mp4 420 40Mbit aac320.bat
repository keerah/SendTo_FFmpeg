...
SET "wset.hline1=Preset: h264 mp4 CUDA 420, slow, 40 Mbps, kf 2 sec, Audio aac320"
SET "wset.params=-v %vbl% -hide_banner -stats"
SET "wset.videocomp=-c:v h264_nvenc -preset slow -b:v 40M -pix_fmt yuv420p -force_key_frames 0:00:02"
	REM The output video will have keyframes each 2 seconds due to -force_key_frames 0:00:02
SET "wset.audiocomp=-c:a aac -b:a 320k"
