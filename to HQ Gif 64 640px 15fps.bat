...
ECHO [---  Preset: Gif 64 colors, 640px width, 15 fps, 2 pass                              ---]
...
SET "wset.prepass=-vf "fps=15,scale=640:-1:flags=lanczos,palettegen=max_colors=64""
SET "wset.videocomp=-filter_complex "fps=15,scale=640:-1:flags=lanczos[x];[x][1:v]paletteuse""
...
IF %dscr% GTR 0 (SET "wset.dscr=_hqgif64_640_15") ELSE (SET "wset.dscr=")
