...
SET "wset.out.video.scale.x=400"
...
SET "wset.out.format=.png"
SET "wset.out.video.codec=png"
SET "wset.out.video.sampling=rgb48be"
	REM png supports: rgb48be, rgba64be, rgb24, rgba, pal8, gray, ya8, gray16be, ya16be, monob
