...
ECHO Preset: Gif 256 colors, 640px width, 24 fps, 2 pass
...
SET "wset.prepass=-vf "fps=24,scale=640:-1:flags=lanczos,palettegen""
SET "wset.videocomp=-filter_complex "fps=24,scale=640:-1:flags=lanczos[x];[x][1:v]paletteuse""
...
IF %dscr% GTR 0 (SET "wset.dscr=_hqgif256_640_24") ELSE (SET "wset.dscr=")
